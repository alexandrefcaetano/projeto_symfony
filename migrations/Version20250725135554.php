 ...
 */
final class Version20250725135554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE socio (id SERIAL NOT NULL, empresa_id INT DEFAULT NULL, nome VARCHAR(255) NOT NULL, cpf VARCHAR(14) NOT NULL, PRIMARY KEY(id))');
